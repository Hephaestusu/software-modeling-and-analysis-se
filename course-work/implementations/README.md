...
2. Изпълнете файловете в следния ред:
   ...
   `1-Initialization.sql` – създава базата и всички таблици  
   `2-Functions.sql` – добавя потребителската функция  
   `3-Procedures.sql` – добавя съхранената процедура  
   `4-Triggers.sql` – създава тригера и ChannelStats  
   `5-Insert_Data.sql` – зарежда примерни данни  
   `6-DemoQueries.sql` – примерни справки (по желание)
